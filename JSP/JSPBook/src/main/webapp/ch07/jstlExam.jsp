...
<body>
	...
	<c:set var="product2" value="<h2>갤럭시</h2>" />
	<c:set var="inArray" value="${[1,2,3,4,5]}" />
	<p>
		product1(jstl-xml=true): 
		<c:out value="${product1}" default="Not registerd" escapeXml="true" />
	</p>
	<p>
		product1(jstl-xml-false): 
		<c:out value="${product1}" default="Not registerd" escapeXml="false" />
	</p>
